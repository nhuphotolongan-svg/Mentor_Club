 ...
 *
 * macOS port: LARK_CLI mặc định 'lark-cli' (không phải .cmd). Đường dẫn config có
 * thể override bằng env REEL_CONFIG để 1 bộ script chạy cho nhiều khách.
 */
...
const CFG_PATH = process.env.REEL_CONFIG || path.join(ROOT, 'config.local.json');
...
const LARK_CLI   = CFG.LARK_CLI || 'lark-cli';
